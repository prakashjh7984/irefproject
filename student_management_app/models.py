...
class ExamCourses(models.Model):
    id=models.AutoField(primary_key=True)
    course_name=models.CharField(max_length=255)
    course_code=models.CharField(max_length=255,null=True)
    created_at=models.DateTimeField(auto_now_add=True)
...
class Students(models.Model):
    ...
    exam_course=models.ForeignKey(ExamCourses,on_delete=models.DO_NOTHING)
...
class CollegeDocument(models.Model):
    ...
    eighth_comment=models.CharField(max_length=255,null=True,blank=True)
...
class StudentResult(models.Model):
    ...
    # exam_course_id=models.ForeignKey(ExamCourses,on_delete=models.CASCADE)
    subject_id=models.ForeignKey(Subjects,on_delete=models.CASCADE)
    semester_id=models.ForeignKey(Semesters,on_delete=models.CASCADE,null=True)
    subject_credits=models.FloatField(default=0)
    exam_months=models.CharField(max_length=255,null=True)
    total_internal_marks=models.CharField(max_length=255)
    subject_internal_marks=models.FloatField(default=0)
    total_external_marks=models.CharField(max_length=255)
    subject_external_marks=models.FloatField(default=0)
    total_marks=models.FloatField(default=0)
    total_max_marks=models.CharField(max_length=255,null=True)
    exam_status =models.CharField(max_length=255,null=True)
...
def create_user_profile(sender,instance,created,**kwargs):
    if created:
        ...
        if instance.user_type==3:
            Students.objects.create(admin=instance,course=Courses.objects.get(id=1),exam_course=ExamCourses.objects.get(id=1), session_year=SessionYearModel.object.get(id=1),country=Country.objects.get(id=2),state=State.objects.get(id=2),permanent_address="",communication_address="",mobile="",highest_qualification="",work_experience="",profile_pic="",gender="",father_name="",mother_name="",date_of_birth="2020-01-01",session_joining_month="",final_fees="",other_information="",admission_type="",admission_status="",currency_type="",prn_number="",alternate_mobile="")
